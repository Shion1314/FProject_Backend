...
router.get('/', async (req, res) => {
    ...
    if (university_name) {
      const universityInfo = await info.findOne({
        attributes: ['university_name', 'sat_score_25th', 'sat_score_75th', 'act_score_25th', 'act_score_75th','gpa_avg', 'admissions_rate', 'tuition_instate_full', 'tuition_outstate_full', 'popular_major','id'],
