...
* CHECK IF THIS ONE IS CORRECT https://github.com/Shion1314/FProject_Backend/blame/9cb35503a8f35e119c0064debc7a5fa63c46c7d4/Route/%40me.js#L16-L25
...
>
#### For ALEX :so for the backend req its says for each model "Write routes that return individual instances from each model based on their IDs"  but I don't think we have one for favoriteUniversity so we just not include and give a reason or just not include the link for it.
